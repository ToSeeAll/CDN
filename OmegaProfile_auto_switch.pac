var FindProxyForURL = function(init, profiles) {
    ...
    "+auto switch": function(url, host, scheme) {
        "use strict";
        if (/(?:^|\.)ccaeo\.com$/.test(host)) return "+proxy";
        if (/(?:^|\.)jsdelivr\.net$/.test(host)) return "DIRECT";
        if (/(?:^|\.)jsons\.cn$/.test(host)) return "DIRECT";
        if (/(?:^|\.)biancheng\.net$/.test(host)) return "DIRECT";
        if (/(?:^|\.)39\.net$/.test(host)) return "DIRECT";
        if (/(?:^|\.)hdslb\.com$/.test(host)) return "DIRECT";
        if (/(?:^|\.)tiany-cat\.herokuapp\.com$/.test(host)) return "+proxy";
        if (/(?:^|\.)cloudflareinsights\.com$/.test(host)) return "+proxy";
        if (/(?:^|\.)proot\.ml$/.test(host)) return "DIRECT";
        if (/(?:^|\.)caddyserver\.com$/.test(host)) return "+proxy";
        if (/(?:^|\.)gstatic\.com$/.test(host)) return "+proxy";
        if (/(?:^|\.)go\.dev$/.test(host)) return "DIRECT";
        if (/(?:^|\.)cloudflare\.com$/.test(host)) return "+proxy";
        if (/(?:^|\.)bootcss\.com$/.test(host)) return "DIRECT";
        if (/(?:^|\.)serveo\.net$/.test(host)) return "+proxy";
        ...
        if (/(?:^|\.)sda1\.dev$/.test(host)) return "+proxy";
        if (/(?:^|\.)chkaja\.com$/.test(host)) return "+proxy";
        if (/(?:^|\.)snow-plus\.net$/.test(host)) return "+proxy";
        if (/(?:^|\.)twimg\.com$/.test(host)) return "+proxy";
        if (/(?:^|\.)google\.com$/.test(host)) return "+proxy";
        if (/(?:^|\.)sharepoint\.com$/.test(host)) return "DIRECT";
        if (/^192\.168\.1\.106$/.test(host)) return "DIRECT";
        if (/(?:^|\.)kemono\.party$/.test(host)) return "+proxy";
        if (/^192\.168\.1\.107$/.test(host)) return "DIRECT";
        if (/(?:^|\.)cloudflareworkers\.com$/.test(host)) return "+proxy";
        if (/(?:^|\.)stripe\.com$/.test(host)) return "+proxy";
        if (/(?:^|\.)wp\.com$/.test(host)) return "+proxy";
        if (/(?:^|\.)herokucdn\.com$/.test(host)) return "+proxy";
        if (/(?:^|\.)coolice\.ml$/.test(host)) return "DIRECT";
        if (/(?:^|\.)xukunx\.cn$/.test(host)) return "+proxy";
        if (/(?:^|\.)stats\.gov\.cn$/.test(host)) return "DIRECT";
        if (/(?:^|\.)typekit\.net$/.test(host)) return "DIRECT";
        if (/(?:^|\.)book118\.com$/.test(host)) return "DIRECT";
        if (/(?:^|\.)ruyo\.net$/.test(host)) return "DIRECT";
        if (/(?:^|\.)91porny\.com$/.test(host)) return "+proxy";
        if (/(?:^|\.)huafouxx\.com$/.test(host)) return "+proxy";
        if (/(?:^|\.)oungx\.com$/.test(host)) return "+proxy";
        if (/(?:^|\.)tiaokan\.app$/.test(host)) return "+proxy";
        if (/(?:^|\.)xoimg\.com$/.test(host)) return "+proxy";
        if (/(?:^|\.)251\.sh$/.test(host)) return "+proxy";
        ...
        if (/(?:^|\.)vscode-cdn\.net$/.test(host)) return "+proxy";
        if (/(?:^|\.)ping\.cn$/.test(host)) return "DIRECT";
        if (/(?:^|\.)vaiwan\.com$/.test(host)) return "DIRECT";
        if (/(?:^|\.)chaoxing\.com$/.test(host)) return "DIRECT";
        if (/(?:^|\.)cedexis-test\.com$/.test(host)) return "+proxy";
        if (/(?:^|\.)filemanager\.ai$/.test(host)) return "+proxy";
        if (/(?:^|\.)cu\.ma$/.test(host)) return "+proxy";
        if (/(?:^|\.)weebly\.com$/.test(host)) return "+proxy";
        if (/(?:^|\.)editmysite\.com$/.test(host)) return "+proxy";
        if (/(?:^|\.)us-central1-sq-sgtm-prod\.cloudfunctions\.net$/.test(host)) return "+proxy";
        if (/(?:^|\.)squarecdn\.com$/.test(host)) return "+proxy";
        if (/(?:^|\.)onetrust\.com$/.test(host)) return "+proxy";
        if (/(?:^|\.)d1g145x70srn7h\.cloudfront\.net$/.test(host)) return "+proxy";
        if (/(?:^|\.)webhostingsecretrevealed\.net$/.test(host)) return "+proxy";
        if (/(?:^|\.)awardspace\.com$/.test(host)) return "+proxy";
        if (/(?:^|\.)wixsite\.com$/.test(host)) return "+proxy";
        if (/(?:^|\.)mail\.com$/.test(host)) return "DIRECT";
        if (/(?:^|\.)uicdn\.com$/.test(host)) return "DIRECT";
        if (/(?:^|\.)ui-portal\.de$/.test(host)) return "+proxy";
        if (/(?:^|\.)intel\.com$/.test(host)) return "+proxy";
        if (/(?:^|\.)ajax\.googleapis\.com$/.test(host)) return "+proxy";
        if (/(?:^|\.)nestify\.com$/.test(host)) return "+proxy";
        if (/(?:^|\.)bilibili\.com$/.test(host)) return "DIRECT";
        if (/(?:^|\.)bilivideo\.com$/.test(host)) return "DIRECT";
        if (/^192\.168\.1\.106$/.test(host)) return "DIRECT";
        if (/:\/\/192\.168\.1\.106\//.test(url)) return "DIRECT";
        if (scheme === "http" && url.indexOf("192.168.1.106") >= 0) return "DIRECT";
        if (/(?:^|\.)manjaro\.org$/.test(host)) return "+proxy";
        if (/(?:^|\.)chirmyram\.top$/.test(host)) return "DIRECT";
        if (/(?:^|\.)microsoft\.com$/.test(host)) return "DIRECT";
        if (/(?:^|\.)duokan\.com$/.test(host)) return "DIRECT";
        if (/(?:^|\.)piwigo\.com$/.test(host)) return "DIRECT";
        if (/(?:^|\.)piwigo\.org$/.test(host)) return "DIRECT";
        if (/(?:^|\.)educity\.cn$/.test(host)) return "DIRECT";
        if (host[host.length - 1] >= 0 && isInNet(host, "192.168.1.106", "255.255.0.0")) return "DIRECT";
        if (/(?:^|\.)weiyun\.com$/.test(host)) return "DIRECT";
        if (/(?:^|\.)cdn-go\.cn$/.test(host)) return "DIRECT";
        if (/(?:^|\.)bootstrapcdn\.com$/.test(host)) return "+proxy";
        if (/(?:^|\.)mi\.com$/.test(host)) return "DIRECT";
        if (/(?:^|\.)myzfile\.herokuapp\.com$/.test(host)) return "+proxy";
        if (/(?:^|\.)huya\.com$/.test(host)) return "DIRECT";
        if (/^192\.168\.*/.test(host)) return "DIRECT";
        if (/(?:^|\.)18comic\.vip$/.test(host)) return "+proxy";
    ...
    "+proxy": function(url, host, scheme) {
        "use strict";
        if (/^127\.0\.0\.1$/.test(host) || /^::1$/.test(host) || /^localhost$/.test(host) || /^192\.168\.1\.106$/.test(host)) return "DIRECT";
        return "SOCKS5 192.168.1.107:20170; SOCKS 192.168.1.107:20170";
    }
});